...
본 프로젝트의 소스 코드를 빌드하려면 DirectX SDK(June 2010) 이 설치되어 있어야 하고 DirectX SDK(June 2010) 의 기본 설치 폴더인 C:\Program Files (x86)\Microsoft DirectX SDK (June 2010) 에 설치되어 있어야 합니다. 또한 VC++ 2008 이 설치되어 있어야 합니다.
